        ...
        <div>
            ...
            <Container>
                ...
                <Row className="about-text">
                    <h2>INTRODUCTION</h2>
                    <p>
                        Hi, welcome to my website! I created this site to experiment with front-end development using ReactJS and keep a photo journal for fun.
                        I love to travel and explore new places, even if it's in the cornfields of Indiana. Luckily, there's also plenty to explore when I come home 
                        to California. I'm an avid Yelper and usually the go-to person for restaurant suggestions. If you're traveling to any of the 
                        places I've been to or have any suggestions for me, feel free to connect with me on any of the social media listed on the contact page!
                    </p>
